...
ggplot(event_data, aes(x = high, y = low)) +
  ...
  geom_text(aes(label = geo), vjust = -0.8, size = 3) +
  labs(
...
#line 326-337 selects data that is been used
#line 340 creates the plot with high education on x and low education on y
#line 345-348 adds title and axis labels
