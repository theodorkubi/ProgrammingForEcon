...
This plot treats the COVID-19 pandemic as an event and compares obesity level of all EU countries before it (2019) and after it (2022). This graph shows that in most countries the obesity rate decreased. This really goes against everyone's thought that obesity should have increased during the pandemic. This raises the question if the data that we used is sufficient.
This graph all matters for our social problem because an event like this can change the life for a lot of people. Since we want to know how a difference in life can change obesity, Covid can help explain it.
Unfortunately our data cannot give a full explanation how covid changed obesity because there is a difference in countries where it increased and where it decreased. We also don't have the data for the different education groups of obesity rates of 2022. 
